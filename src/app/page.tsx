  ...
  return (
    <main id="content">
      <section className="container" style={{ padding: "var(--space-16) 0" }}>
        ...
        <p>Hey hey! I’m a <strong>Staff Product Designer</strong> — passionate about crafting <strong>cutting‑edge complex tooling</strong>   , <strong>AI workflows</strong>, and <strong>digital–craft being used creatively</strong>.</p>
          <p><strong>Focus Time</strong> moments I’ve helped create are on millions of PCs. The <strong>Daiquery Notebook</strong> work enabled almost everyone at Meta to make decisions better with AI‑enabled workflows. I’ve helped build such projects as <strong>Cognos Analytics powered by Watson</strong>, early steps of IBM’s <strong>Carbon Design System</strong>, and the early days of <strong>Viva Insights</strong>.</p>
          ...
          <p>The focus has been software design but I have bachelor degrees in Mechanical Engineering and Technical Communications, a Master of Science in Information Science Human-Computer Interaction, and some Master of Architecture and Master of Science In Digital Fabrication work.</p>
